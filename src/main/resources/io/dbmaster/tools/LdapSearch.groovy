...
public class LdapSearch {
    ...
    public List<Attributes> search(String server, String searchBase, String searchQuery, String attributes) {
        ...
        def dirContext = connector.connect().getContext()

        def context = new  InitialLdapContext(dirContext.getEnvironment(), null)

        dbm.closeResourceOnExit(context)
        dbm.closeResourceOnExit(dirContext)
